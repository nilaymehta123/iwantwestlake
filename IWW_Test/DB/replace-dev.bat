...
del %filename_prefix%-Dev.sql
..\..\tools\mysql-5.6.25\mysqldump.exe --user=DevMySQL_dev0 --password=Testing.Dev0 --max_allowed_packet=1G --host=alabang1.hankeyinvestments.dev0 --port=3306 --default-character-set=utf8 "temp_migrate_%num%" --result-file=%filename_prefix%-Dev.sql
..\..\tools\mysql-5.6.25\mysql --user=DevMySQL_dev0 --password=Testing.Dev0 --host=alabang1.hankeyinvestments.dev0 --execute="drop database if exists temp_migrate_%num%"